...
# Adding fps and video write output to show in frame by : Kiena
...
class lcd:
    ...
    # Show CPU and Temperature of Raspberry pi
    def usagecpu(self):
        while self.running:
...
class tflite_detection:
    ...
    # Fungsi untuk menjalankan deteksi objek
...
# Membuat thread baru untuk menjalankan fungsi deteksi objek
